---
description: "Train and deploy a gesture recognition model on ESP32 boards using Edge Impulse, covering data collection, model training, and on-device inference."
title: Edge Impulse Gesture Recognition
sidebarTitle: "Edge Impulse"
---
