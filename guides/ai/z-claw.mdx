---
description: "Build the Z-Claw robotic gripper that uses on-device AI and computer vision on ESP32 to detect, classify, and pick up objects autonomously."
title: "Z-Claw AI Object Detection"
---
