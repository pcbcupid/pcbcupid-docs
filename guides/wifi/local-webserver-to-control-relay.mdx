---
description: "Host a local web server on a Glyph ESP32 board to switch a two-channel relay on and off from a browser for remote control of lights or appliances."

title: "Control a Dual Relay over Wi-Fi"
sidebarTitle: "Wi-Fi Dual Relay"
---
