---
description: "Wire a 16x2 parallel LCD to a Glyph ESP32 board and print text using the LiquidCrystal library, covering pin connections and example code."
title: "Parallel LCD Display"
sidebarTitle: "Parallel LCD"
---
