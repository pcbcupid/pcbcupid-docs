---
description: "Connect the HC-SR04 ultrasonic distance sensor to the Glyph ESP32-C6 board, send a trigger pulse, and measure distance using the echo response."
title: "HC-SR04 Ultrasonic Sensor with Glyph"
---
