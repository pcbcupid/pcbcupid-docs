---
description: "Read direction, position, and button presses from a rotary encoder on the Glyph ESP32-C6 board using interrupts and example Arduino code."
title: "Rotary Encoder with Glyph ESP32-C6"
sidebarTitle: "Rotary Encoder"
---

<iframe
  className="w-full aspect-video rounded-xl"
  src="https://www.youtube.com/embed/ecCt8cw4js8?si=kkVtwp_yOrLE5PbP"
