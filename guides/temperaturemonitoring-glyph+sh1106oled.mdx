---
description: "Fetch live temperature data from the OpenWeatherMap REST API on a Glyph ESP32 board and display readings on an SH1106 OLED screen over I2C."
title: "REST API Weather on SH1106 OLED"
sidebarTitle: "REST API Weather with OLED"
---

<iframe
  className="w-full aspect-video rounded-xl"
  src="https://www.youtube.com/embed/S1nY8qvV_r8?si=HoQsZewTdlRxZH5A"
