---
description: "Set up a Bluetooth Low Energy server on a Glyph ESP32 board, advertise a custom service, and exchange data with a phone or BLE central device."
title: "BLE Server Demo"
sidebarTitle: "BLE Server"
