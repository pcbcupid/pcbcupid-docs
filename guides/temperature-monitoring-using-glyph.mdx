---
description: "Call the OpenWeatherMap REST API from a Glyph ESP32 board over Wi-Fi, parse JSON responses, and log temperature and humidity to the serial monitor."
title: "OpenWeatherMap REST API"
sidebarTitle: "REST API Weather"
---
