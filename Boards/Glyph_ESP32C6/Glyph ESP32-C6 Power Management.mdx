...
title: Glyph ESP32-C6 Power Management  
---

## Power Management for Glyph ESP32-C6

### Battery + USB Power

We designed the Glyph ESP32-C6 to be easy to power both when connected to a computer and via a battery. Here are the ways to power your Glyph:
...
The Glyph ESP32-C6 offers multiple power supply options:
...
For powering the Glyph ESP32-C6:
...
The Glyph ESP32-C6 is not designed for external power supplies. If you must:
