...
<ImgGallery modelUrl="https://spell-files.pcbcupid.com/pc-module/3d-model-c/glb/GM013-DC-DC-BOOST/GM013-DC-DC-BOOST-c.glb" images={[{ url: 'https://files.pcbcupid.com/Documentation/Boards/g-mod/Boost_convertor/Boost_convertor_illustration.avif', label: 'ILLUSTRATION VIEW', id: 'illustration' }, { url: 'https://via.placeholder.com/800x450?text=Board+View Coming Soon', label: 'BOARD VIEW', id: 'board' }]} />
