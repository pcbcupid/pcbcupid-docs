...
<ImgGallery images={[{url: "https://files.pcbcupid.com/Documentation/Boards/gadgets/usb-to-rs485/usb-to-rs485-illustration.avif", label: "ILLUSTRATION VIEW", id: "illustration"}, {url: "https://files.pcbcupid.com/Documentation/Boards/Gadgets/usb2rs485-Board_View.avif", label: "BOARD VIEW", id: "board"}]} />
